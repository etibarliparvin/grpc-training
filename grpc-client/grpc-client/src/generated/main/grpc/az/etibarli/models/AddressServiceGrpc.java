...
public final class AddressServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<az.etibarli.models.AddressRequest,
      az.etibarli.models.AddressResponse> getGetAddressMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getAddress",
      requestType = az.etibarli.models.AddressRequest.class,
      responseType = az.etibarli.models.AddressResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<az.etibarli.models.AddressRequest,
      az.etibarli.models.AddressResponse> getGetAddressMethod() {
    io.grpc.MethodDescriptor<az.etibarli.models.AddressRequest, az.etibarli.models.AddressResponse> getGetAddressMethod;
    if ((getGetAddressMethod = AddressServiceGrpc.getGetAddressMethod) == null) {
      synchronized (AddressServiceGrpc.class) {
        if ((getGetAddressMethod = AddressServiceGrpc.getGetAddressMethod) == null) {
          AddressServiceGrpc.getGetAddressMethod = getGetAddressMethod =
              io.grpc.MethodDescriptor.<az.etibarli.models.AddressRequest, az.etibarli.models.AddressResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getAddress"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  az.etibarli.models.AddressRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  az.etibarli.models.AddressResponse.getDefaultInstance()))
              .setSchemaDescriptor(new AddressServiceMethodDescriptorSupplier("getAddress"))
              .build();
        }
      }
    }
  ...
  public static abstract class AddressServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getAddress(az.etibarli.models.AddressRequest request,
        io.grpc.stub.StreamObserver<az.etibarli.models.AddressResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                az.etibarli.models.AddressRequest,
                az.etibarli.models.AddressResponse>(
  ...
  public static final class AddressServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AddressServiceBlockingStub> {
    ...
    /**
     */
    public az.etibarli.models.AddressResponse getAddress(az.etibarli.models.AddressRequest request) {
  ...
  public static final class AddressServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AddressServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<az.etibarli.models.AddressResponse> getAddress(
        az.etibarli.models.AddressRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ADDRESS:
          serviceImpl.getAddress((az.etibarli.models.AddressRequest) request,
              (io.grpc.stub.StreamObserver<az.etibarli.models.AddressResponse>) responseObserver);
          break;
        default:
